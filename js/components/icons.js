...
const ICONS = {
  ...
  walk: `<circle cx="34" cy="12" r="6" fill="#FFB25E"/>
    <path d="M4 40q10-10 20-4t20-8" fill="none" stroke="#E3C083" stroke-width="4" stroke-linecap="round"/>
  ...
  music: `<path d="M10 30V16a14 14 0 0128 0v14" fill="none" stroke="#4A3F6B" stroke-width="3.5"/>
  ...
  pineapple: `<ellipse cx="24" cy="30" rx="12" ry="14" fill="#FFC94D" stroke="#D9A02C" stroke-width="2"/>
    <path d="M16 22l16 16M32 22L16 38" stroke="#D9A02C" stroke-width="1.8"/>
  ...
  shell: `<path d="M24 8c11 0 18 12 18 21 0 7-8 11-18 11S6 36 6 29C6 20 13 8 24 8z" fill="#FFE3C7" stroke="#E3A97E" stroke-width="2.5"/>
    <path d="M24 11v28M16 14l2 25M32 14l-2 25M10 21l4 18M38 21l-4 18" stroke="#E3A97E" stroke-width="1.8"/>`,
...
export function icon(id, extraClass = '') {
  ...
  return `<svg class="icon ${extraClass}" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">${body}</svg>`;
}
